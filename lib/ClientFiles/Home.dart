...
import "../DataSet/Subscription.dart";
    ...
    class _HomeState extends State<Home> {
      ...
      Future<void> CheckSubscriptionStatus(GymDocID, OrderID)
      async {
        var SubscriptionOrder = await Subscription.GetSubscriptionOrderFromDOCID(GymDocID, OrderID);
      ...
      Future<void> CheckSubscription() async {
        ...
        if(Subs.length == 0)
          {
            ...
            Navigator.push(context, MaterialPageRoute(builder: (context) => SetupGym(account: widget.account)));
          }
        else if(Subs.length != 0 && CurrentSubscription == null)
        {
          ...
          var defsub = await Subscription.CheckDefaultSubscriptionOrder(widget.account.DocID, CurrentSubscription);
      ...
      void UpdateinSeconds(){
        Timer.periodic(Duration(seconds: 1), (timer) async {
          ...
          strpos = pos.latitude.toString() +  " " + pos.longitude.toString();
          setState(() {
        ...
        return Scaffold(
          body: Container(
            ...
            child: Column(
              ...
              children: [
              Header(),
              GymHome(account: widget.account,),
              Footer(),
              //Footer(),
            ],)
          ),
